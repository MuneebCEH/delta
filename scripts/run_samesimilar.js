...
async function run() {
    ...
    try {
        ...
        log("Filling form fields for: ALANIZ...");
        ...
        await typeField('Mbi', '3QD0CE4UU36');
        await typeField('BeneficiaryDob', '10/10/1958');
        await typeField('BeneficiaryLastName', 'ALANIZ');
        await typeField('BeneficiaryFirstName', 'MATILDE ');
        await typeField('DateOfService', '8/28/2025' || '02/15/2026');
        ...
        if ('DIABETES EQUIPMENT, SUPPLIES, AND SHOES') {
            await toolFrame.evaluate(() => {
            ...
            }, 'DIABETES EQUIPMENT, SUPPLIES, AND SHOES');
        } else if ('') {
            await toolFrame.evaluate(() => {
